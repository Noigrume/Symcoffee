 ...
 */
final class Version20210621115437 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE purchase DROP purchased_at, CHANGE total_price total INT NOT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE purchase ADD purchased_at DATETIME NOT NULL, CHANGE total total_price INT NOT NULL');
    }
}
